...
<div class="container my-3 p-3 bg-warning-subtle">
  <form action="<?= $_SERVER['SCRIPT_NAME'] ?>" method="POST">
    <div class="row mb-2">
      <div class="col">
        <input type="text" class="form-control" id="user_name" name="user_name" placeholder="ニックネーム..." minlength="0" maxlength="16" value="<?= isset($_SESSION['user_name']) ? h($_SESSION['user_name']) : '' ?>">
